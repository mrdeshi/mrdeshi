...
| 3D Graphics Engine | Handmade |  | A 3D graphics engine in C++ with a stereo mode for VR, used to build a playable 3D Tower of Hanoi game where the discs are moved with a Leap Motion and stylized hands are drawn on screen. |
